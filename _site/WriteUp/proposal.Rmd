...
Lastly, we wish to make use of time series visualization techniques such as cyclic plots and horizon plots to allow users to observe patterns and trends from time series data. 
